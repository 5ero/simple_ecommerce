...
<div class="relative bg-white overflow-hidden">
  <div class="max-w-7xl mx-auto">
    <div class="relative z-10 pb-8 bg-white sm:pb-16 md:pb-20 lg:max-w-2xl lg:w-full lg:pb-28 xl:pb-32">
      ...
      <div class="relative pt-6 px-4 sm:px-6 lg:px-7">
        <nav class="relative flex items-center justify-between sm:h-10 lg:justify-start" aria-label="Global">
          ...
          <div class="hidden md:block md:ml-8 md:pr-1 md:space-x-1">

            <a href="#" class="font-medium text-gray-600 hover:text-white hover:bg-indigo-600 px-2 py-1 rounded">Home</a>

            <a href="#" class="font-medium text-gray-600 hover:text-white hover:bg-indigo-600 px-2 py-1 rounded">Products</a>

            <a href="#" class="font-medium text-gray-600 hover:text-white hover:bg-indigo-600 px-2 py-1 rounded">About</a>

            <a href="#" class="font-medium text-gray-600 hover:text-white hover:bg-indigo-600 px-2 py-1 rounded">Contact</a>
        ...
        <div class="rounded-lg shadow-md bg-white ring-1 ring-black ring-opacity-5 overflow-hidden">
          <div class="px-5 pt-4 flex items-center justify-between">
            <div>
              ...
              <img class="h-12" src="/img/balloon-boxes-indigo-600.png">
            </div>
            <div class="-mr-2">
  ...
  <div class="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
    <img class="h-56 w-full object-cover sm:h-72 md:h-96 lg:w-full lg:h-full" src="/img/balloons.jpg" alt="">
  </div>
</div>
  </div>
