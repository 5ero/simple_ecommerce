<nav  x-data="{ mobile: false }" >
	...
	<div class="flex">
		<div class="flex items-baseline flex-grow">
			...
			<div class="hidden md:block w-96 pt-4 ml-10">
				<div class="flex justify-around">
						...
						<livewire:navbar-link slot="Products" :active="request()->routeIs('products')"/>
		...
		<div class="hidden md:block">
			<div class="px-4 py-1 text-sm text-white bg-gradient-to-t from-blue-600 to-blue-500 rounded-b h-8">	
